import { Create, SimpleForm, TextInput, NumberInput, required, useRedirect, useNotify, useDataProvider, ReferenceArrayInput, AutocompleteArrayInput,SelectInput } from "react-admin";
...
export const AdvertisementCreate = () => (
    <Create resource="advertisements">
        ...
        <SelectInput source="international_student_recruitment" label="留学生採用"
    choices={[
        { id: true, name: "有り" },
        { id: false, name: "無し" },
        { id: null, name: "不明" },
